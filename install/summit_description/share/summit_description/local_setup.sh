...
: ${AMENT_CURRENT_PREFIX:="/home/user/summit_ws/install/summit_description"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/summit_description/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/summit_description/environment/path.sh"
